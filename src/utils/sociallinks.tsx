...
const ListItem = ({ data }) => {
    return (
        <li className="inline-block social-link mx-2">
            <a href={data.url} title={data.name} rel="nofollow noopener" target="_blank"  className="rounded-full inline-block transition-shadow duration-300 hover:shadow-2xl">
